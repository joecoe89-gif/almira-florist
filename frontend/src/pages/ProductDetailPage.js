      ...
      <div className="px-6 md:px-12 lg:px-24 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-2xl font-semibold text-primary mt-4" data-testid="product-detail-price">{formatRupiah(product.price)}</p>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <Button className="rounded-full px-8 py-3 flex-1 hover:scale-[1.02] transition-transform" onClick={handleAddToCart} disabled={product.stock <= 0} data-testid="add-to-cart-btn">
